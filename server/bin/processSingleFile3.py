        ...
        def resolveValue(self,tag,dataset,data):
                ...
                if len(tag) == 1:
                        ...
                        if not ( int(tag[0],0), int(tag[1],0) ) in dataset:
                             ...
                             tempData = dataset[int(tag[0],0), int(tag[1],0)][0]
                             if not (int(tag[2],0), int(tag[3],0)) in tempData:
                                 taghere = False
                             else:
                        ...
                        if not ( int(tag[0],0), int(tag[1],0) ) in dataset:
                            ...
                            if not (int(tag[2],0), int(tag[3],0)) in tempData:
                                ...
                                tempData2 = dataset[int(tag[0],0), int(tag[1],0)][0][int(tag[2],0), int(tag[3],0)][0]
                                if not (int(tag[4],0), int(tag[5],0)) in tempData2:
                                    taghere = False
                                else:
        ...
        def run(self):
                ...
                while True:
                        ...
                        if not response:
                                ...
                                #igore dicom file come with following names: UNKNOWN.
                                #Need RAW dicomfile to be pass through :
                                if "UNKNOWN" in dicomfile:
                                    continue
