...
$command = escapeshellcmd('python /var/www/html/php/getParticipantInfoFromLoris.py --token='.$token.'  --id-triplet='.$id_triplet.' --fiona-id='.$fiona_id.' --scann-date='.$scann_date);
#echo ($command);
$output = exec($command);
#echo $output;
